...
> Consultation fees, balances, payment records, and invoices.

**Component ID:** `clinic-billing`
...
Generate invoices for consultation fees, track balances, and record payments.

## Business problem solved

Clinic billing is often manual and disconnected from the patient visit. This component links billing to the visit.
...
- `defaultConsultationFeeCents` (`number`, default `5000`) — Default consultation fee.
...
Invoice amounts, payment history, patient identity. Financial data — commercially sensitive.
