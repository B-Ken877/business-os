...
> Doctors, nurses, assistants, roles, and schedules.

**Component ID:** `clinic-staff-management`
...
Maintain clinic staff records (doctors, nurses, assistants), their roles, and their schedules.

## Business problem solved

Staff info is scattered. This component makes it queryable and links to appointment scheduling.
...
- Create staff profiles with roles
- Track specialties (for doctors)
...
- `maxStaffPerTenant` (`number`, default `500`) — Cap on staff records.
...
Staff name, role, specialty, contact. PII.
...
- No schedule management — use a separate scheduling component.
