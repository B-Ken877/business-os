...
> Teacher records, assignments, workload, and contact details.

**Component ID:** `school-teacher-management`
...
Maintain teacher profiles, link them to class sessions (via school-class-scheduling), and compute workload.

## Business problem solved

Teacher info is scattered. This component makes it queryable and links to scheduling.
...
- `maxWorkloadHoursPerWeek` (`number`, default `30`) — Maximum teaching hours per week.
...
Teacher name, contact, subjects, workload. Personally identifiable.
...
- No workload computation yet — requires school-class-scheduling integration.
