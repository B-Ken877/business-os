# Configuration Reference — `retail-customer-management`
...
|---|---|---|---|
| `maxCustomersPerTenant` | `number` | `100000` | Cap on customer records. |

## Overriding per tenant

```ts
import { defaultConfig } from "@business-os/reusable-components/retail-shops/retail-customer-management/config/defaults";
