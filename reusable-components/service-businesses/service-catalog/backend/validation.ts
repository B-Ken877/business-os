/**
 * Input validation helpers for the service-catalog component.
 *
...
export function validateCreateServiceInput(input: CreateServiceInput): Result<CreateServiceInput> {
